...
class AliPay(object):
    ...
    def verify(self, data, signature): # 支付成功后回调对支付宝的信息进行反向签名的认证
...
if __name__ == "__main__":
    ...
    url = alipay.direct_pay(
        subject="测试订单",
        out_trade_no="20170202ss",# 每次的订单号不能重复了
        total_amount=100,
        return_url="http://47.95.8.70:8000/alipay/return/"
    )
